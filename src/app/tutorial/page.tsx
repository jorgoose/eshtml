...
const tutorialContent = {
  ...
  4: {
    ...
    lessons: [
      ...
      { id: "4-2", title: "Encapsulando Contenido", href: "/tutorial/semantica/encapsulando-contenido", description: "Usa divs y spans eficazmente" },
      { id: "4-3", title: "Elementos Semánticos", href: "/tutorial/semantica/elementos-semanticos", description: "Haz que tu página sea más fácil de entender para todos" }
    ]
  },
  5: {
