...
export default function Parrafos() {
  const [example] = useState({
    eshtml: `<e1>Los Planetas</e1>
<p>Los planetas son cuerpos celestes que giran alrededor del Sol.</p>
<p>Hay ocho planetas en nuestro sistema solar.</p>`
  });

  const [userCode, setUserCode] = useState(`<e1>Mi Animal Favorito</e1>
<!-- Escribe aquí un párrafo sobre tu animal favorito... -->`);
  const transpiler = useMemo(() => new EsHTMLTranspiler(), []);
  ...
  return (
    <div className="min-h-screen bg-[#111827]">
      <Nav />
      <TutorialSidebar activePath="/tutorial/elementos/p" />
            ...
            <div className="space-y-6">
              <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700/50">
                <p className="text-lg text-gray-300">
                  El elemento <code className="text-orange-400">&lt;p&gt;</code> se usa para crear párrafos de texto. Cada párrafo es un bloque de texto separado que ayuda a organizar y estructurar el contenido de tu página.
                </p>
              </div>
              ...
              <div className="bg-gray-800/50 p-6 rounded-lg">
                <ul className="space-y-3 text-gray-300">
                  <li>• Usa <code className="text-orange-400">&lt;p&gt;</code> para cada párrafo nuevo</li>
                  <li>• Los párrafos aparecen en líneas separadas automáticamente</li>
                  <li>• Puedes usar tantos párrafos como necesites</li>
                </ul>
              </div>
              ...
              <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700/50 mb-6">
                <p className="text-lg text-gray-300">
                  Usando el título que ya está escrito, añade dos párrafos describiendo por qué es tu animal favorito.
                  Recuerda usar las etiquetas <code className="text-orange-400">&lt;p&gt;</code> para cada párrafo.
                </p>
              </div>
